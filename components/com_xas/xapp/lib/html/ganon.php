 ...
 * @license
 *  +http://dev.perl.org/licenses/artistic.html Artistic License
 *  +GPL
 *
 */

//START ganon.php
function ganon_str_get_dom($str, $return_root = true) {
	$a = new HTML_Parser_HTML5($str);
	return (($return_root) ? $a->root : $a);
}
function ganon_file_get_dom($file, $return_root = true, $use_include_path = false, $context = null) {
