 ...
 *            Xapp-Studio.com support@xapp-studio.com
...
$audioPlayerEmbed = "{SITEURL}/{FOLDER}/{SOURCE}.{FILE_EXT}";
...
//http://www.youtube.com/watch?v=3jafUqtfWlg&feature=youtube_gdata_player
"youtube" => "http://www.youtube.com/embed/{SOURCE}",
"podcast" => "{SITEURL}/index.php?option=com_podcastmanager&format=raw&feedname={SOURCE}",
...
"vimeo" => "http://player.vimeo.com/video/{SOURCE}",
...
",
//"soundcloud" => 'http://soundcloud.com/oembed?format=js&iframe=true&callback=soundcloud{SOURCEID}&auto_play={PLAYER_AUTOPLAY}&maxwidth={WIDTH}&url={SOURCE}'
