        ...
        if(func_num_args() > 0)
        {
            ...
            if($ns !== null)
            {
                if(array_key_exists($ns, self::$_instances))
                {
                    ...
                    throw new Xapp_Cache_Exception("no cache instance under ns: $ns registered", 1530102);
                }
            }else{
            ...
            if(self::$_instance !== null)
            {
                ...
                throw new Xapp_Cache_Exception("can not get current cache class instance since no instance has been set yet", 1530101);
            }
        }
    }
