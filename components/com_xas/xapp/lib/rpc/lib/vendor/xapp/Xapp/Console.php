...
class Xapp_Console implements Xapp_Singleton_Interface
{
    ...
    protected function __construct($driver, Array $options = array())
    {
        ...
        switch($this->_driver)
        {
            ...
            case 'chromephp':
                ...
                break;
            default:
                throw new Xapp_Error("xapp console driver: $driver not supported", 1090101);
        }
    }
    ...
    public function log($mixed = null, $label = null, $type = 'info', Array $options = array())
    {
        ...
        if(array_key_exists($type, self::$_typeMap))
        {
                ...
                case 'firephp':
                    switch($type)
                    {
                        ...
                        case 'trace':
                            ...
                            break;
                        case 'dump':
                            $this->console->dump($label,$options);
                            break;
                        default:
            ...
            throw new Xapp_Error("xapp console log type: $type not supported", 1090801);
        }
    }
}