...
class Xapp_Util_Json
{
     ...
     * @throws Xapp_Util_Exception_Json
     * @return string
     */
    public static function encode($value, $options = 0)
    {
        if(function_exists('json_encode'))
        {
            ...
            throw new Xapp_Util_Exception_Json("function json_encode not supported by system", 1650101);
        }
    }
    ...
    public static function decode($json, $assoc = false, $depth = 512, $options = 0)
    {
        if(function_exists('json_decode'))
        {
            ...
            throw new Xapp_Util_Exception_Json("function json_decode not supported by system", 1650201);
        }
    }
